...
context('Actions', () => {
    ...
    it('PR039', () => {
      ...
      let addtitle = ' ' + cy.faker.lorem.words(2)
      cy.xpath("//textarea[@placeholder='Post title']").type(addtitle)
      cy.screenshot();
      title += addtitle;

      cy.get('.koenig-editor__editor-wrapper').type(cy.faker.lorem.paragraph())
      cy.screenshot();
