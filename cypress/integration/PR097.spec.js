...
describe('Escenarios datos a priori', () => {
  ...
  it('Escenario 97: Create member with email and note correct', () => {
    ...
    cy.fixture('configuration').then((configuration)  => {
      ...
      cy.get('input[id=member-email]').type(datapool[19].email_member)
      cy.wait(2000)
      cy.get('#member-note').type(datapool[19].note_member)
      cy.wait(2000)
